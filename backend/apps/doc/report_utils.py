...
os.environ.setdefault("DJANGO_SETTINGS_MODULE","iSpaceDoc.settings")
...
from backend.apps.doc.report_html2pdf import convert
import traceback
import time
import markdown
import yaml
            ...
            <html xmlns="http://www.w3.org/1999/xhtml">
              ...
              <body class="bookname">
                  <div class="main">
                    ...
                    <p class="book-src">本书籍由<a href='http://mrdoc.zmister.com'>iSpaceDoc(mrdoc.zmister.com)</a>生成</p>
                  </div>
            </body>
            </html>
        '''.format(
        ...
        content_info = '''<?xml version="1.0" encoding="utf-8" ?>
            <package version="2.0" xmlns="http://www.idpf.org/2007/opf" unique-identifier="uid" >
              <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
                ...
                <dc:publisher>iSpaceDoc制作</dc:publisher>
