...
<body>
	<h1>XML站点地图源 - 索引</h1>
	<div id="header">
		<p>这是爱思文档站点地图索引，用来帮助搜索引擎，比如<a href="https://www.google.com">Google</a>, <a href="https://www.bing.com/">Bing</a>, <a href="https://www.yahoo.com">Yahoo!</a> 和 <a href="https://www.baidu.com">百度</a>更好地索引你的网站。 可以在<a href="https://www.sitemaps.org/">Sitemaps.org</a>上阅读更多有关于XML站点地图的信息</p>
	</div>
	<div id="content">
		<table cellpadding="5">
			<tr class="high">
