...
- [优化]增加 card 类型代码块颜色位；
- [优化]合并 PR[#153](https://github.com/zmister2016/iSpaceDoc/pull/153)；
...
- [优化]合并PR[!29 优化dockerfile](https://gitee.com/zmister/iSpaceDoc/pulls/29)
...
- [优化]首页底部iSpaceDoc标识，调整为「Powered By iSpaceDoc」；
...
- [修复]用户token api 无法上传URL图片的问题[!28](https://gitee.com/zmister/iSpaceDoc/pulls/28)；
...
- [修复]个人中心文档数量不匹配的问题；
- [修复]首页新建文集的样式问题[#I50XRV](https://gitee.com/zmister/iSpaceDoc/issues/I50XRV)；
...
- [合并][!25](https://gitee.com/zmister/iSpaceDoc/pulls/25)修复iceEditor截图粘贴上传
- [优化]文档页面转发按钮文字标识；
...
- [新增]首页文集置顶功能；
- [合并]GitHub [#61Editor.md编辑器引用块样式](https://github.com/zmister2016/iSpaceDoc/pull/61)
...
- [新增]个人中心文集管理的文集搜索功能；
- [新增]文档编辑器浏览器缓存功能；
- [合并]文集简介优化[!1](https://gitee.com/zmister/iSpaceDoc/pulls/1)
- [合并]Editor.md编辑器自定义文档样式[#42](https://github.com/zmister2016/iSpaceDoc/pull/42)
